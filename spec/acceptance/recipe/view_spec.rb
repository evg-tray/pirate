...
feature 'View recipes', %q{
  ...
  scenario 'Any user view user`s public recipes' do
    ...
    expect(page).to have_content public_recipes[0].flavors_recipes[0].flavor.name
    expect(page).to have_content public_recipes[1].name
    expect(page).to have_content public_recipes[1].flavors_recipes[0].flavor.name
  ...
  scenario 'Any user view pirate diy recipes' do
    ...
    expect(page).to have_content pirate_diy_recipes[0].flavors_recipes[0].flavor.name
    expect(page).to have_content pirate_diy_recipes[1].name
    expect(page).to have_content pirate_diy_recipes[1].flavors_recipes[0].flavor.name
  end
end
